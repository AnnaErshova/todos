...
class Robot(date, temp)
  # the robot should return a string "I am #fillthisin"
  return "I am #{emotion}"
  
  if date > 15 && temp > 70 && temp <= 100
