class Compliment
	...
	"You have an Izzy Blow — but non-suicidal — super pretty face vibe,” it reads, referring to the late stylist and designer muse, Isabella Blow. “Your look is killing it today. The way I picture you is in Lula magazine, floating on a sea of chiffon and blowing bubbles in a rainstorm. Turbans equal difficult-to-pull-off, but today, and probably usually, you are a queen of awesome.",
	...
	IMAGES = [           "<img src='localhost:9393/public/image1.jpg'>", 
						"<img src='localhost:9393/public/image2.jpg'>",
						"<img src='localhost:9393/public/image3.jpg'>", 
						"<img src='localhost:9393/public/image4.jpg'>",
						"<img src='localhost:9393/public/image5.jpg'>", 
						"<img src='localhost:9393/public/image6.jpg'>",
						"<img src='localhost:9393/public/image7.jpg'>",
						"<img src='localhost:9393/public/image8.png'>"  ]
